...
class Test_Company_Information:
    ...
    def test_validating_mobilenumb(self, setup):
        ...
        if mobile != country_af:
            ...
            self.driver.save_screenshot(
                screenShort.screen_short() + "BEN_CO_CONTACTINFO_test_validating_mobilenumb.png")
            assert False
    ...
    def test_with_sending_sp_char_num_data(self, setup):
        ...
        if not error_msg == "Required":
            ...
            self.driver.save_screenshot(
                screenShort.screen_short() + "BEN_CO_CONTACTINFO_test_with_sending_sp_char_num_data.png")
            assert False
        self.driver.quit()
