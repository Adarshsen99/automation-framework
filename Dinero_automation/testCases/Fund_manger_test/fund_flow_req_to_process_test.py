...
from Dinero_automation.pageObjects.Fund_manager import Requests, Tobeapproved, Rejected, Processed, Tobeprocessed
...
class Test_approved:
    ...
    def test_sending_valid_data(self, setup):
        ...
        self.rjt = Rejected(self.driver)
        self.tbp = Tobeprocessed(self.driver)
        self.pdd = Processed(self.driver)
        ...
        self.rq.fund_request().send_keys("1500000")
        time.sleep(2)
        ...
        self.tba.fund_approved().send_keys("1500000")
        time.sleep(2)
        ...
        self.tba.Fc_amount().send_keys("1500000")
        ...
        # to be processed action

        self.tbp.click_tbproce()
        time.sleep(2)

        serpro = self.tbp.drp_serv_pro()
        time.sleep(2)

        self.tbp.ser_pro_search().send_keys("Phenomenal")

        self.tbp.select_phenom_money()
        self.tbp.search_btn()
        time.sleep(2)

        self.tbp.click_phenom()
        time.sleep(3)

        self.tbp.fund_procesed().send_keys("1500000")
        ...
        self.pdd.click_processed()
        time.sleep(2)

        serpro = self.pdd.drp_serv_pro()
        time.sleep(2)

        self.pdd.ser_pro_search().send_keys("Phenomenal")

        self.pdd.select_phenom_money()
        self.pdd.search_btn()
        time.sleep(2)
