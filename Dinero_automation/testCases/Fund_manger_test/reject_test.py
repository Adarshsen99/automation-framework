...
from Dinero_automation.pageObjects.Fund_manager import Requests, Tobeapproved, Rejected
...
class Test_approved:
    ...
    def test_sending_valid_data_name(self, setup):
        ...
        self.rq.fund_request().send_keys("2100000")
        time.sleep(2)
        ...
        self.tba.fund_approved().send_keys("2100000")
        time.sleep(2)
        ...
        self.tba.Fc_amount().send_keys("2100000")

        self.tba.click_confirm()
        time.sleep(3)
        self.tba.click_rejected()

        time.sleep(2)

        self.rjt.click_rejected()
