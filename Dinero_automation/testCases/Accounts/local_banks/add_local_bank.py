...
class TestSendingDocs:
    ...
    def test_sending_valid_data(self, setup):
        ...
        acc_num.send_keys("454543543")
        Iban = self.acp.IBAN_num()
        Iban.send_keys("23523523")
        ...
        card_number_1.send_keys("2758426758")
        ...
        card_number_2.send_keys("27584267358")
