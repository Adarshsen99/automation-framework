...
class Test_Delegate_Editmode:
    ...
    #             screenShort.screen_short() + "Edit_BENEFICIARY_test_delegate_edit_valiadting_by_same_name.png")
    #         assert False
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "Edit_BENEFICIARY_test_delegate_edit_valiadting_search_bar.png")
    #         assert False
    #
    #     self.driver.quit()
