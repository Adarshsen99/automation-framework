...
class Test_Other_Info_Editmode:
    ...
    # def test_beneficiary_edit_valiadating_Relationship(self,setup):
    #     responce = []
    #     # Setup the driver for each iteration
    #     self.driver = setup
    #     self.driver.get(self.url)
    ...
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "Edit_BENEFICIARY_test_beneficiary_edit_valiadating_Relationship_relation_val.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "Edit_BENEFICIARY_test_beneficiary_edit_valiadating_Relationship_customers_values.png")
    #         assert False
    #
    #     self.driver.quit()

    # def test_beneficiary_edit_valiadating_Beneficially_Owned_Companies_selecting_drp(self,setup):
    #     responce = []
    #     # Setup the driver for each iteration
    #     self.driver = setup
    #     self.driver.get(self.url)
    ...
    #     #         assert True
    #
    #     self.driver.get("http://www.dinero.local/customer/indi/461")
    #     time.sleep(2)
    #     self.pi = Personal_Information_Edit(self.driver)
    #     self.ci = Contact_Information_Edit(self.driver)
    #     self.id = Id_details_Edit(self.driver)
    ...
    #
    #     anul_currency = Select(self.oi.drp_annual_income_currency())
    #     anul_currency.select_by_index(2)
    #
    #     time.sleep(10)
    #
    #     self.oi.check_privacy_info().click()
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "Edit_BENEFICIARY_test_beneficiary_edit_valiadating_Beneficially_Owned_Companies_selecting_drp.png")
    #         assert False
