...
#       assign the data
    ...
    def test_sending_space_data(self, setup):
        self.driver = setup
        self.driver.get(self.url)
        self.driver.maximize_window()
        self.driver.implicitly_wait(30)
        ...
        a_name = "Shaik Bash"
        b_num = "1223 4567"
        b_name = "monlash Building"
        stre = "nellore dist"
        po = "524309 654"
        dist = "Kerala State"
        num = "7641524344 542"
        mai = "finne st@tech.com"
        ...
        if self.comp_info.errorMessage() == "Required":
            ...
            self.driver.save_screenshot(screenShort.screen_short() + "CRC_test_sending_space_data.png")
            assert True
