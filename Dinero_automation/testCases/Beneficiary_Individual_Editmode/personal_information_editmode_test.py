...
class Test_Personal_Information:
    ...
    # def test_same_id_number_with_different_beneficiary(self,setup):
    #     responce = []
    #     # login setup
    #     self.driver = setup
    #     self.driver.get(self.url)
    ...
    #
    #     id_type = Select(self.pi.drp_id_type())
    #     id_type.select_by_index(3)
    #
    #     id_num = self.pi.id_num()
    #     id_num.clear()
    #     numb = "9866935960"
    #     id_num.send_keys(numb)
    #     id_num_val_bf = id_num.get_attribute('value')
    #     print("id_num_val:",id_num_val_bf)
    #
    #     time.sleep(2)
    #     self.pi.btn_next().click()
    #     time.sleep(2)
    ...
    #     self.fp.btn_save().click()
    #
    #     self.driver.get("http://www.dinero.local/beneficiary/indi/256")
    #
    #     self.pi = Personal_Details_Editmode(self.driver)
    #     self.ci = Contact_Information_Editmode(self.driver)
    #     self.bi = Bank_Information_Editmode(self.driver)
    ...
    #     id_num.send_keys(numb)
    #     id_num_val_af = id_num.get_attribute('value')
    #     print("id_num_val_af:", id_num_val_af)
    #
    #     time.sleep(2)
    #     self.pi.btn_next().click()
    #     time.sleep(2)
    ...
    #     time.sleep(2)
    #
    #     if self.fp.editmode_message():
    #         assert True
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_same_id_number_with_different_beneficiary.png")
    #         assert False

    def test_adding_beneficiary_only_mandatory_fields(self,setup):
        responce = []
        # login setup
        self.driver = setup
        self.driver.get(self.url)
        ...
        if not mname_val_af:
            ...
            self.driver.save_screenshot(
                screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields.png")
            assert False

    # def test_adding_beneficiary_only_mandatory_fields_checking_pre(self,setup):
    #     responce = []
    #     # login setup
    #     self.driver = setup
    #     self.driver.get(self.url)
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_title.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_fname.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_mname.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_lname.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_sname.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_cob.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_nationality.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_relation.png")
    #         assert False
    #
    ...
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_idtype.png")
    #         assert False
    #
    #     if id_num_val == self.ci.id_number_pre():
    #         assert True
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_idnum.png")
    #         assert False
    #
    #     if trans_type_val == self.ci.transaction_type_pre():
    #         assert True
    #     else:
    #         self.driver.save_screenshot(
    #             screenShort.screen_short() + "EDIT_BENEFICIARY_INDIVIDUAL_test_adding_beneficiary_only_mandatory_fields_checking_pre_transtype.png")
    #         assert False
    #
    #     self.driver.quit()
