...
class Test_Beneficiaries_Editmode:
    ...
    def test_validating_removing_beneficiary_after_save(self, setup):
        self.driver = setup
        self.driver.get(self.url)
        self.driver.maximize_window()
        self.driver.implicitly_wait(30)
        ...
        if beneficiary_name_bf != beneficiary_name_af:
            ...
            self.driver.save_screenshot(
                screenShort.screen_short() + "Edit_BENEFICIARIES_test_validating_removing_beneficiary_after_save.png")
            assert False
