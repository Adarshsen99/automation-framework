...
class Test_delegate_details:
    ...
    def test_sending_valid_data_name(self, setup):
        ...
        if delegate_name_value == "Akash  p mani":
            assert True
        else:
    ...
    def test_bulk_data(self, setup):
        ...
        # click action for Delegate details
        delegate_names_bulk = ['Chavadam venkata', 'Akash p', ' stiya theresa']
    ...
    def test_delegate_value_undefined(self, setup):
        ...
        #
        # print(
        #     f" del_name_pg_val: {del_name_pg_val}, del_arabic_name_pg_val: {del_arabic_name_pg_val}, del_gendder_pg_val: {del_gendder_pg_val}")
